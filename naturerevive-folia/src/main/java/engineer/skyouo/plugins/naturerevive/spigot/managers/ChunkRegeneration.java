...
public class ChunkRegeneration {
    ...
    public static void regenerateChunk(BukkitPositionInfo bukkitPositionInfo) {
        ...
        Bukkit.getRegionScheduler().runDelayed(instance, chunk.getWorld(), chunk.getX(), chunk.getZ(), (scheduledTask) -> {
            Bukkit.getPluginManager().callEvent(new ChunkPopulateEvent(chunk));
        }, 4L);
    }
