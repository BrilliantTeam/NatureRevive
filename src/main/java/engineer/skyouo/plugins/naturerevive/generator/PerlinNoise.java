package engineer.skyouo.plugins.naturerevive.generator;

import java.security.SecureRandom;
import java.util.Random;

// Original Author: https://gist.github.com/alksily/7a85a1898e65c936f861ee93516e397d
...
public class PerlinNoise {
    ...
    public PerlinNoise() {
        this.seed = new SecureRandom().nextGaussian() * Integer.MAX_VALUE;
        init();
    }
